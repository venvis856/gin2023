...
type Permission struct {
	...
	Type                 int64  `gorm:"column:type" json:"type"`                                     //  类型 1菜单 2普通权限
	Scene                int64  `gorm:"column:scene" json:"scene"`                                   //  场景 1 后台 2 app 3 大屏
	FatherPermissionCode string `gorm:"column:father_permission_code" json:"father_permission_code"` //  父权限code
	Status               int64  `gorm:"column:status" json:"status"`                                 //  1：正常 5 禁用  9 删除
