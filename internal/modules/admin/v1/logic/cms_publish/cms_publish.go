...
type CmsPublishLogic struct{}

func init()  {
	service.RegisterCmsPublish(New())
}

func New() service.PublishInterface {
	return &CmsPublishLogic{}
}


func (receiver *CmsPublishLogic) Publish(c *gin.Context, param service.PublishParam) error {
	// 主记录信息
