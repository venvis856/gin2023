...
func (a *Hotel) InitPermission(identifyId int64, roleId int64, tx *gorm.DB) error {
	permissions := []*models.Permission{
		...
		// 盒子节点列表
		{PermissionName: "节点列表", PermissionCode: "web_box_list", FatherPermissionCode: "web_system", IdentifyId: identifyId, Type: models.TYPE_MENU, Scene: models.SCENE_WEB, Status: 1, CreateTime: carbon.Now().Timestamp()},
		{PermissionName: "节点详情", PermissionCode: "web_box_info", FatherPermissionCode: "web_box_list", IdentifyId: identifyId, Type: models.TYPE_NORMAL, Scene: models.SCENE_WEB, Status: 1, CreateTime: carbon.Now().Timestamp()},
		{PermissionName: "节点新增", PermissionCode: "web_box_add", FatherPermissionCode: "web_box_list", IdentifyId: identifyId, Type: models.TYPE_NORMAL, Scene: models.SCENE_WEB, Status: 1, CreateTime: carbon.Now().Timestamp()},
		{PermissionName: "节点修改", PermissionCode: "web_box_update", FatherPermissionCode: "web_box_list", IdentifyId: identifyId, Type: models.TYPE_NORMAL, Scene: models.SCENE_WEB, Status: 1, CreateTime: carbon.Now().Timestamp()},
		{PermissionName: "节点删除", PermissionCode: "web_box_delete", FatherPermissionCode: "web_box_list", IdentifyId: identifyId, Type: models.TYPE_NORMAL, Scene: models.SCENE_WEB, Status: 1, CreateTime: carbon.Now().Timestamp()},
