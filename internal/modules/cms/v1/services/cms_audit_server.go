...
type CmsAuditServer struct{}

// 生成记录
func (a *CmsAuditServer) MakeAudit(auditDetailList []map[string]interface{}, makeType int, makeUserId int, siteId int) (int64, error) {
...
func (*CmsAuditServer) UpdatePageFirstMakeTime(pageIds []int) error {
